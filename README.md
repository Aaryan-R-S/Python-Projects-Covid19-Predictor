...
<p align="center">
  ...
  <h3 align="center">Covid-19 Predictor</h3>
...
This is a python app which can predict chances of a patient having Covid-19!
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Covid19-Predictor.git
   ```
- Python Modules
  - `pip install pandas` 
  - `pip install numpy` 
